 ...
 */
final class Version20231005075251 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_C74404555932F377 ON client (center_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_C74404555932F377 ON client');
        $this->addSql('ALTER TABLE client CHANGE center_id centro_id VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE client ADD CONSTRAINT FK_C7440455298137A7 FOREIGN KEY (centro_id) REFERENCES center (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
