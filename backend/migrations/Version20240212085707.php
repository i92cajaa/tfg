 ...
 */
final class Version20240212085707 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE appointment ADD CONSTRAINT FK_FE38F844716232E5 FOREIGN KEY (mentor_survey_id) REFERENCES document (id) ON UPDATE NO ACTION ON DELETE SET NULL');
