...
final class Version20240409112444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE schedule (id VARCHAR(255) NOT NULL, lesson_id VARCHAR(255) NOT NULL, status_id INT NOT NULL, room_id VARCHAR(255) NOT NULL, teacher_id VARCHAR(255) NOT NULL, date_from DATETIME NOT NULL, date_to DATETIME NOT NULL, INDEX IDX_5A3811FBCDF80196 (lesson_id), INDEX IDX_5A3811FB6BF700BD (status_id), INDEX IDX_5A3811FB54177093 (room_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE schedule ADD CONSTRAINT FK_5A3811FB41807E1D FOREIGN KEY (teacher_id) REFERENCES user (id) ON DELETE CASCADE');
